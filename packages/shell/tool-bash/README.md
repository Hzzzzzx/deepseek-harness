...
| `description` | string (required) | One-line, active-voice summary of the command (5-10 words) in the user's conversation language, for UI/log display only — no effect on execution. |
