...
export const zh = {
  ...
  'row.failed': '失败',
  'row.stopped': '已停止',
  'row.state.running': '正在{verb}',
  'row.state.ok': '已{verb}',
  'row.state.error': '{verb}失败',
  'row.state.stopped': '已停止{verb}',
  'row.verb.search': '搜索',
  'row.verb.read': '读取',
  'row.verb.bash': '运行',
  'row.verb.write': '写入',
  ...
  'row.exitCode': ' · 退出码 {code}',
  'group.summary': '已{verbs}',
  'group.verbs.read': '读取 {count} 个文件',
  'group.verbs.search': '搜索 {count} 次',
  'group.verbs.bash': '运行 {count} 条命令',
  'group.verbs.write': '写入 {count} 个文件',
  'group.verbs.edit': '修改 {count} 个文件',
  'group.verbs.code': '执行 {count} 段代码',
  'group.verbs.others': '调用 {count} 个工具',
  'group.errors': ' · {count} 个错误',
  'group.expand': '展开工具过程',
  'group.collapse': '收起工具过程',
  'think.running': '思考中',
  'think.settled': '已完成思考',
  'queue.count': '{n} 条排队消息',
  'queue.edit': '编辑排队消息',
...
export const en = {
  ...
  'row.failed': 'Failed',
  'row.stopped': 'Stopped',
  'row.state.running': '{verb}…',
  'row.state.ok': '{verb} done',
  'row.state.error': '{verb} failed',
  'row.state.stopped': '{verb} stopped',
  'row.verb.search': 'Search',
  'row.verb.read': 'Read',
  'row.verb.bash': 'Run',
  'row.verb.write': 'Write',
  'row.verb.edit': 'Edit',
  'row.verb.code': 'Run code',
  'row.verb.others': 'Call',
  'row.duration': ' · {duration}',
  'row.exitCode': ' · exit {code}',
  'group.summary': '{verbs} done',
  'group.verbs.read': 'read {count} files',
  'group.verbs.search': 'searched {count} times',
  'group.verbs.bash': 'ran {count} commands',
  'group.verbs.write': 'wrote {count} files',
  'group.verbs.edit': 'edited {count} files',
  'group.verbs.code': 'ran {count} code blocks',
  'group.verbs.others': 'called {count} tools',
  'group.errors': ' · {count} errors',
  'group.expand': 'Show tool activity',
  'group.collapse': 'Hide tool activity',
  'think.running': 'Thinking',
  'think.settled': 'Thought',
