...
/** RFC 4122 v4 UUID from getRandomValues: available on insecure origins too. */
function insecureOriginUuid(): string {
...
function browserDraftAttachment(file: File): ComposerAttachment {
  return {
    ...
    // which browsers also expose on insecure (LAN http) origins.
    id: insecureOriginUuid() as DraftAttachmentId,
